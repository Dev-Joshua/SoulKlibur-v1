...
let akali = new Personaje('Akali', './imgRenderAkali.png', 5);
let pyke = new Personaje('Pyke','./imgRenderPyke.png', 5);
let cronos = new Personaje('Cronos','./imgRenderCronos.png', 5);
